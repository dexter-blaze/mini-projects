...
//        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml");
        ...
        javaCourse.getInstructor().setInstructorDetails("Abhee","25");
//        javaCourse.setInstructor("springInstructor");
        javaCourse.getInstructor().takeClass();
        ...
        springCourse.getInstructor().setInstructorDetails("TimTim", "24");
        springCourse.setCourseDetails("Spring and SpringBoot");
        springCourse.getInstructor().takeClass();
